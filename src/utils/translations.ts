...
export const TRANSLATIONS = {
  en: {
    ...
    footerMessage: '© 2026 MalaysianHomes. Created directly for premium investors & home buyers. Phone: 010-8278932',
  ...
  zh: {
    ...
    themeToggle: '切换视觉主题',
    footerMessage: '© 2026 大马优居 (MalaysianHomes). 专为中高端买家与国际投资者打造。热线：010-8278932',
    compareButton: '对比',
...
const PHRASE_MAP: [RegExp, string][] = [
  ...
  [/heart of/gi, '核心地带'],
  [/view of KL City Centre/gi, '吉隆坡双子塔 (KL City Centre) 壮丽景观'],
  [/KL City Centre view/gi, '双子塔景观'],
  [/views of/gi, '绝美景观：'],
  [/panoramic/gi, '全景'],
...
export function translateArea(area: string): string {
  const map: Record<string, string> = {
    ...
    'Bangsar': '孟沙',
    'Bukit Bintang': '武吉免登',
    'KL City Centre': '吉隆坡市中心 (KL City Centre)',
    'Mont Kiara': '满家乐',
    'Kepong': '甲洞',
    'Sentul': '冼都',
    'Setapak': '文良港',
