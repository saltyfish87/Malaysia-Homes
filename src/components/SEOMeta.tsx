...
export default function SEOMeta({ project, tab, lang, projects = [], area = '' }: SEOMetaProps) {
  ...
  useEffect(() => {
    ...
    jsonLdGraph.push({
      ...
      'alternateName': 'Shyan Yee', 'sameAs': ['https://maps.google.com/?cid=3195643739952877602', 'https://www.youtube.com/@shyanyee', 'https://www.instagram.com/shyanyee/', 'https://www.facebook.com/shyanyeeconsultant/', 'https://wa.me/60108278932'],
